...
import com.ssonzm.common.util.DummyUtil;
...
class UserControllerTest extends DummyUtil {
    ...
    void sinUpTest() throws Exception {
        ...
        UserRequestDto.UserSignUpReqDto userSignUpReqDto = new UserRequestDto.UserSignUpReqDto(name, email, pw, phoneNumber, address);
    ...
    void updatePw() throws Exception {
        ...
        UserRequestDto.UserUpdatePwReqDto userUpdatePwReqDto = new UserRequestDto.UserUpdatePwReqDto(newPw);
    ...
    void updateUserInfo() throws Exception {
        // given
        UserRequestDto.UserUpdateReqDto userUpdatePwReqDto = new UserRequestDto.UserUpdateReqDto("010-7777-7777", "서울광역시 중구");
        String requestBody = om.writeValueAsString(userUpdatePwReqDto);
