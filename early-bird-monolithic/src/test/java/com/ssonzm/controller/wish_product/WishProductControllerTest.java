...
class WishProductControllerTest extends DummyUtil {
    ...
    void saveProductTest() throws Exception {
        // given
        Long productId = 1L;
        WishProductRequestDto.WishProductSaveReqDto wishProductSaveReqDto = new WishProductRequestDto.WishProductSaveReqDto(productId, 5);
    ...
    void updateQuantityTest() throws Exception {
        ...
        Long productId = 1L;
        WishProductRequestDto.WishProductUpdateReqDto wishProductUpdateReqDto = new WishProductRequestDto.WishProductUpdateReqDto(wishProductId, productId, 5);
