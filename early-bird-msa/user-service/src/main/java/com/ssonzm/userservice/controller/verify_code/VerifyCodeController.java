package com.ssonzm.userservice.controller.verify_code;

import com.ssonzm.coremodule.dto.ResponseDto;
import com.ssonzm.coremodule.util.ResponseUtil;
import com.ssonzm.userservice.service.verify_code.VerifyCodeService;
...
public class VerifyCodeController {
    ...
    public ResponseEntity<?> verifyCode(@RequestParam String email, @RequestParam String verifyCode) {
        ...
        ResponseDto<?> responseDto = ResponseUtil.setResponseDto(messageSource, isEqual);
